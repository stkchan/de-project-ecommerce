# de_project_ecommerce

The 'de_project_ecommerce' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/de_project_ecommerce/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] de_project_ecommerce_etl` to your workspace.
